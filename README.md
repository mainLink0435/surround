...
This project uses git submodules for the `openmpt` and `audiodecoder.openmpt` dependencies. When cloning, use the `--recurse-submodules` flag to automatically fetch all dependencies:

```bash
git clone --recurse-submodules git@github.com:mainLink0435/surround.git
```
